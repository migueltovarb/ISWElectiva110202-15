...
export default function NewParkingAreaPage() {
      ...
      if (err.response?.data) {
        if (typeof err.response.data === 'object') {
          const errorMessages = Object.entries(err.response.data)
            ...
            .join('; ');
          setError(errorMessages || 'Error al crear el área de estacionamiento');
        } else {
          setError(err.response.data);
        }
      } else {
        setError('Error al crear el área de estacionamiento. Por favor, intente nuevamente.');
      }
    } finally {
      setLoading(false);
    }
  ...
  const isFormValid = () => {
    return formData.name.trim() && formData.max_capacity > 0;
  };
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-semibold text-gray-900">Nueva Área de Estacionamiento</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                ...
                <div className="sm:col-span-2">
                  ...
                  <p className="mt-2 text-sm text-gray-500">Número máximo de vehículos</p>
                </div>
                ...
                <div className="sm:col-span-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                      <label htmlFor="is_active" className="font-medium text-gray-700">Área activa</label>
          ...
          <div className="bg-gray-50 px-4 py-4 sm:px-6 border-t border-gray-200">
            <div className="text-sm text-gray-600">
              ...
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>La capacidad máxima debe ser un número positivo</li>
                <li>Una vez creada, puede modificar la información más tarde</li>
                <li>Las áreas inactivas no aparecerán en el sistema de control</li>
              </ul>
            </div>
          </div>
        </div>
